...
DROPBOX_TEST_DATA_PATH <- "BanditDemo/test data"
DROPBOX_TEST_CLEANED_DATA_PATH <- "BanditDemo/test_cleaned"
DROPBOX_ASSIGNMENT_DATA_PATH <- "BanditDemo/assignment"
DROPBOX_ASSIGNMENT_CLEANED_DATA_PATH <- "BanditDemo/assignment_cleaned"
